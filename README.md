...
🛠️ Tech Stack
LayerTechFrontendNext.js, TypeScript, Tailwind CSSBackendFastAPI, Python 3.11DatabasePostgreSQL + SQLAlchemy asyncVector StoreChromaDB (persistent)LLMGemini 2.5 Flash LiteEmbeddingsGemini text-embedding-004PDF GenerationReportLabDeploymentRender + Vercel

🌸 Other Projects

interview-copilot — Realtime AI workspace for interview prep with Blind 75 tracker
astramind — AI-driven financial report intelligence
second-brain — AI knowledge base with RAG and semantic search
mindmapme — Minimal mood tracker and journaling app
